...
import 'package:vezeeta/features/auth/logic/auth_bloc.dart';
import 'package:vezeeta/features/auth/logic/auth_states.dart';
import 'package:vezeeta/features/auth/ui/forgot_password.dart';
import 'package:vezeeta/features/auth/ui/signup.dart';
...
class _SignInState extends State<SignIn> {
  ...
  Future<void> _loadSavedEmail() async {
    ...
    if (rememberMe) {
      final savedEmail = CacheHelper.getString('saved_email') ?? '';
      setState(() {
